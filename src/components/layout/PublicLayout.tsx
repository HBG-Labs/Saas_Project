          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className={cn(
                ...
                isLandingPage
                  ? 'border-0 bg-transparent text-blue-400 hover:text-white shadow-none p-0 rounded-none'
            ...
            {isAuthenticated ? (
              ...
              <>
                {isLandingPage ? (
                  <Link to={ROUTES.login} className="hidden text-xs font-semibold text-blue-400 hover:text-white transition-colors lg:inline-flex">
                    Connexion
                  </Link>
                ) : (
                ...
                {isLandingPage ? (
                  <Link to={ROUTES.register} className="text-xs font-bold text-blue-400 hover:text-white transition-colors">
