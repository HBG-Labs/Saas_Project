...
export function DocumentNumberingBanner({
  ...
  return (
    <div className="border-info-border bg-primary-subtle text-foreground mx-auto flex w-full max-w-xl items-center gap-3 rounded-xl border px-4 py-2.5 shadow-xs">
      <AlertCircle className="text-primary size-5 shrink-0" aria-hidden="true" />
      ...
      <Button
        ...
        size="sm"
        onClick={onModify}
        className="bg-surface/80 gap-1.5"
      >
