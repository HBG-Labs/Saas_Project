      ...
      {tabs.map((tab) => {
        ...
        return (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                'atelier-action-tab min-h-touch inline-flex flex-1 shrink-0 items-center justify-center gap-1.5 rounded-xl px-2 py-2 text-xs font-semibold transition-[color,background-color,box-shadow,transform] duration-150 active:scale-[0.98] sm:min-h-0 sm:flex-initial sm:shrink sm:gap-1.5 sm:px-3',
